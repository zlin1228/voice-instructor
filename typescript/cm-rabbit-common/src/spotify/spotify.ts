...
export const os2SpotifyPlayerControlType = objectType([
  {
    name: "playSearchTop",
    type: objectType([
...
export type Os2SpotifyPlayerControl = CookType<
  typeof os2SpotifyPlayerControlType
>

export const os2SpotifyPlayerStatusType = objectType([
  {
    name: "playing",
    type: booleanType,
  },
...
export type Os2SpotifyPlayerStatus = CookType<typeof os2SpotifyPlayerStatusType>
