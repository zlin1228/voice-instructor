...
export const os2ClientMessageKernelUserTextType = objectType([
  ...
  { name: "uuid", type: stringType },
  { name: "character", type: stringType },
] as const)

export const os2ClientMessageKernelUserAudioType = objectType([
  { name: "character", type: stringType },
...
export const os2ClientMessageKernelType = objectType([
  ...
  {
    name: "userAudio",
    type: os2ClientMessageKernelUserAudioType,
    optional: true,
  },
  {
    name: "listening",
...
export const os2ServerMessageKernelType = objectType([
  ...
  {
    name: "assistantResponseFinalized",
    type: stringType,
    optional: true,
  },
  {
